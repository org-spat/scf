package org.spat.scf.protocol.sfp;

import org.spat.scf.protocol.compress.CompressBase;
...
import org.spat.scf.protocol.secure.DESCoderHelper;
...
public class Protocol {
     ...
     * @throws Exception
     */
    public static Protocol fromBytesOnlySFP(byte[] data, boolean rights, byte[] desKey) throws Exception {
        Protocol p = new Protocol();
        int startIndex = 0;
        if(data[startIndex] != Protocol.VERSION) {
        	throw new Exception("协义版本错误");
