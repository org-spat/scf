...
public class ProxyClassCreaterV2 {
	...
	//				classLoader.findClass(implClassName);
	//				Class<?> implCls = classLoader.findClass(sessionBean.getInterfaceName());
					
	//				Class<?> implCls = classLoader.loadClass(sessionBean.getInterfaceName());
	...
	public String createMethods(String className, MethodInfo mi) {
		...
		sb.append(methodName);
		sb.append("(" + Constant.SCFCONTEXT_CLASS_NAME + " context) throws " + Constant.SERVICEFRAMEEXCEPTION_CLASS_NAME + " {"); // begin method
