...
import org.spat.scf.client.secure.SecureKey;
...
//    private ServiceConfig serviceConfig;
    ...
    public ScoketPool(Server server, ServiceConfig serviceconfig) {
        ...
        this.secureKey = serviceconfig.getSecureKey();
        this.serviceName = serviceconfig.getServicename();
    }
    
    public ScoketPool(Server server, SocketPoolProfile socketPoolConfig, KeyProfile secureKey, String serviceName) {
    	this.server = server;
    	this.socketPoolConfig = socketPoolConfig;
    	this.queue = new CQueueL(socketPoolConfig.getShrinkInterval(), socketPoolConfig.getMinPoolSize());
...
//        }
        ...
        */
        ...
        String keyInfo = secureKey.getInfo();//授权文件
        ...
        //HandclaspProtocol handclaspProtocol_mw = (HandclaspProtocol)Protocol.fromBytes(receiveDESKey).getSdpEntity();
        /**
        * 解密获取DES密钥
        */
...
//class CQueue extends ConcurrentLinkedQueue<CSocket> {
//
//    private int _duration;
//    private int _minConn;
//    private final Object shrinkLockHelper = new Object();
//    private List<CSocket> _AllSocket = Collections.synchronizedList(new ArrayList<CSocket>());
//    
//    public CQueue(int _duration, int _minConn) {
//        this._duration = _duration;
//        this._minConn = _minConn;
//    }
//
