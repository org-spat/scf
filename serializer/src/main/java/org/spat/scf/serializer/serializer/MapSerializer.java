...
//            if (valueType == null) {
//                throw new ClassNotFoundException("Cannot find class with typId,target class:map[value]" + ",typeId:" + valueTypeId);
//            }
//            Object value = SerializerFactory.GetSerializer(valueType).ReadObject(inStream, valueType);
